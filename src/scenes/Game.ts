...
export class Game extends Phaser.Scene {
    ...
    create() {
        ...
        this.healthText = this.add.text(850, 10, 
        ...
        this.scoreText = this.add.text(850, 30, 
        ...
        this.helpText = this.add.text(10, 10, 
            'Use arrow keys to move (up to jump) and space to attack', {
                fontFamily: 'Arial Black',
                fontSize: 24,
                color: '#ffffff',
                stroke: '#000000',
        ...
        this.time.addEvent({
            ...
            callback: () => {
                if (this.player) {
                    ...
                    const enemyY = 200
                    const enemy = Enemy.addEnemy(this, enemyX, enemyY,
                        'enemySprite', 10)
    ...
    update() {
        if (this.player && this.cursors && this.enemies) {
            ...
            this.enemies.getChildren().forEach(
                (enemy: Phaser.GameObjects.GameObject) => {
                    (enemy as Enemy).update(this.player as Player,
